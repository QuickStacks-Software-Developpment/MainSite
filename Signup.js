...
document.getElementById('quoteForm').addEventListener("submit", function(event) {
    ...
    const packageChosen = document.getElementById("package").value;
    const budget = document.getElementById("budget").value;
    const description = document.getElementById("description").value;

    // Create a reference to the 'websiteRequests' node in the database
    const requestsRef = ref(database, 'websiteRequests');
    ...
    push(requestsRef, {
        ...
        alert("Your request has been successfully submitted! Expect an Email shortyl!");
